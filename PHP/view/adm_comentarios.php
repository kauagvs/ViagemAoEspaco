...
<head>
  ...
  <script type="text/javascript" src="../controller/funcoes_meu_cadastro_adm.js"></script>
    ...
    <div class="col-md-5">
      ...
      <div class="col-md-12 ">
        <div class="painel">
            ...
            <div id="todos_comentarios" class="list-group"></div>

            <div class="botao_home col-md-4"></div>
            <div class="botao_home col-md-4">
              </br>
              <button class="btn btn-danger botao_padrao" id="btn_excluir_todos" type="button"><a href = "../model/excluir_todos_adm.php">Excluir Tudo</button>
            </div>
