        ...
        echo '<div class="list-group-item col-md-12">';
            ...
            echo '<br />';
              echo  '<table>';
                echo  '<tr>';
                  echo   '<td width = 100>';
                  echo "<form method='post' id='form_exclui' action = '../model/excluir_comentario_adm.php'>";
                  ...
                  echo '</td>';
                  echo '<td>';
                  echo "<form method='post' id='form_exclui' action = '../view/alterar_comentario_adm.php'>";
                    echo "<input type ='hidden' id='id_comentario' name ='id_comentario' value = ". $registro['id_comentario']."> ";
